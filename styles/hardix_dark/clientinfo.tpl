...
<tr><td class="Label">Username:</td><td><a href="client://%%CLIENT_ID%%/%%CLIENT_UNIQUE_ID%%~%%CLIENT_NAME_PERCENT_ENCODED%%" class="TextMessage_UserLink">
%%CLIENT_NAME%%&nbsp;</a>
<span class="InfoFrame_CustomNick" title="Custom Nickname" style="text-decoration: none; color: #2FD502">[%%?CLIENT_CUSTOM_NICK_NAME%%]</span>&nbsp;
	%%?CLIENT_COUNTRY_IMAGE_SCALED%%&nbsp;
	...
	<tr><td class="label">myTeamSpeak ID:</td><td>%%?CLIENT_MYTEAMSPEAK_ID%%</td></tr>
...
<tr>
	<td class="label">Last Connected:</td>
...
<tr>
	<td class="label">Client Talk Power:</td>
